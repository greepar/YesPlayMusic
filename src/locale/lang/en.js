export default {
  ...
  login: {
    ...
    notice: `YesPlayMusic promises not to save any of your account information to the cloud.<br />
      ...
      YesPlayMusic is not the official website of NetEase Music, please consider carefully before entering account information. You can also go to <a href="https://github.com/greepar/YesPlayMusic">YesPlayMusic's GitHub repository</a> to build and use the self-hosted NetEase Music API.`,
  ...
  settings: {
    ...
    download: {
      title: 'Download',
      quality: 'Default Download Quality',
      askBeforeDownload: 'Ask quality before every download',
  ...
  toast: {
    ...
    downloadCompleted: 'Download completed: {name}',
    downloadFailed: 'Download failed: {name}',
    alreadyDownloaded: 'Track already downloaded or in queue',
    downloading: 'Downloading in progress, please wait',
  },
  download: {
    title: 'Download Track',
    selectQuality: 'Select Quality',
    rememberChoice: 'Remember this choice and use it by default next time',
    cancel: 'Cancel',
    confirm: 'Download Now',
    quality128Desc: 'Standard quality, small file size',
    quality192Desc: 'Higher bitrate, clear sound',
    quality320Desc: 'Extreme high quality MP3 (320Kbps)',
    qualityFlacDesc: 'Lossless CD quality FLAC',
    qualityHiresDesc: 'Ultra High-Resolution Audio',
    noDownloads: 'No downloaded tracks yet',
    openFolder: 'Open Folder',
    clearHistory: 'Clear List',
    downloadingSection: 'Downloading',
    completedSection: 'Downloaded',
