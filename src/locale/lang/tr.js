export default {
  ...
  login: {
    ...
    notice: `YesPlayMusic hesabınızın hiçbir bilgisini kaydetmeyeceğine dair söz veriyor<br />
      ...
      YesPlayMusic, NetEase Music'in resmi websitesi değildir, lütfen hesap bilgilerinizi girmeden önce dikkatlice düşününüz. Aynı zamanda, Kendi NetEase Musix API'nızı host etmek için <a href="https://github.com/greepar/YesPlayMusic">YesPlayMusic'in GitHub Repo'suna</a> gidebilirsiniz.`,
  ...
  settings: {
    ...
    download: {
      title: 'İndir',
      quality: 'Varsayılan İndirme Kalitesi',
      askBeforeDownload: 'Her indirmeden önce sor',
      path: 'İndirme Klasörü',
      changePath: 'Klasörü Değiştir',
  ...
  contextMenu: {
    ...
    download: 'Şarkıyı İndir',
  },
  toast: {
    savedToMyLikedSongs: 'Beğendiğim Müziklere Kaydet',
    removedFromMyLikedSongs: 'Beğendiğim Müziklerden Kaldır',
    downloadStarted: 'İndirme başladı: {name}',
    downloadCompleted: 'İndirme tamamlandı: {name}',
    downloadFailed: 'İndirme başarısız: {name}',
    alreadyDownloaded: 'Bu şarkı zaten indirildi veya kuyrukta',
  ...
  download: {
    ...
    cancel: 'İptal',
    confirm: 'İndir',
    quality128Desc: 'Standart kalite (128Kbps)',
    quality192Desc: 'Yüksek kalite (192Kbps)',
    quality320Desc: 'Çok yüksek kalite (320Kbps)',
    qualityFlacDesc: 'Kayıpsız FLAC',
    qualityHiresDesc: 'Hi-Res Audio',
    noDownloads: 'Henüz indirilen şarkı yok',
    openFolder: 'Klasörü Aç',
    clearHistory: 'Listeyi Temizle',
    downloadingSection: 'İndiriliyor',
    completedSection: 'İndirilenler',
