export default {
  ...
  login: {
    ...
    notice: `YesPlayMusic 承諾不會保存您的任何帳戶資訊到雲端。<br />
        ...
        <a href="https://github.com/greepar/YesPlayMusic"
  ...
  toast: {
    ...
    downloadCompleted: '下載完成：{name}',
    downloadFailed: '下載失敗：{name}',
    alreadyDownloaded: '該歌曲已在下載清單或已下載',
    downloading: '正在下載中，請稍候',
  },
  download: {
    title: '下載歌曲',
    selectQuality: '選擇下載音質',
    rememberChoice: '記住選擇，下次預設以此音質直接下載',
    cancel: '取消',
    confirm: '立即下載',
    quality128Desc: '標準音質，體積小，適合節省流量',
    quality192Desc: '較高音質，清晰通透',
    quality320Desc: '極高品質 MP3，飽滿聽感',
    qualityFlacDesc: '無損 CD 級母帶音質',
    qualityHiresDesc: '超清高解析音訊，極致聆聽體驗',
    noDownloads: '暫無已下載歌曲',
    openFolder: '開啟下載目錄',
    clearHistory: '清空記錄',
    downloadingSection: '正在下載',
    completedSection: '已完成下載',
    redownload: '重新下載',
    deleteFile: '從本機刪除',
  },
};
