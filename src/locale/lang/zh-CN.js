export default {
  ...
  toast: {
    ...
    downloadCompleted: '下载完成：{name}',
    downloadFailed: '下载失败：{name}',
    alreadyDownloaded: '该歌曲已在下载列表或已下载',
    downloading: '正在下载中，请稍候',
  },
  download: {
    title: '下载歌曲',
    selectQuality: '选择下载音质',
    rememberChoice: '记住选择，下次默认以此音质直接下载',
    cancel: '取消',
    confirm: '立即下载',
    quality128Desc: '标准音质，体积小，适合节省流量',
    quality192Desc: '较高音质，清晰通透',
    quality320Desc: '极高品质 MP3，饱满听感',
    qualityFlacDesc: '无损 CD 级母带音质',
    qualityHiresDesc: '超清高解析音频，极致聆听体验',
    noDownloads: '暂无已下载歌曲',
    openFolder: '打开下载目录',
    clearHistory: '清空记录',
    downloadingSection: '正在下载',
    completedSection: '已完成下载',
    redownload: '重新下载',
    deleteFile: '从本地删除',
  },
};
